        ...
        @foreach($apartments as $apartment)
          ...
          <tr
            ...
            <td class="py-8 pr-5 text-right align-middle">
              @if($isAvailable)
                <x-buttons.primary href="https://flatfox.ch/de/listing{{ $apartment['short_url'] }}submit/" target="_blank" title="Jetzt auf Flatfox anmelden" :icon="false" class="!py-6 !px-10 !text-[12px]">
                  Bewerben
                </x-buttons.primary>
              @else
