...
<div class="bg-dew">
  ...
  <x-layout.inner>
    ...
    <div class="leading-[1.2] text-sm md:text-md lg:text-lg flex flex-col gap-y-25 lg:gap-y-45 max-w-4xl">
      <div>
      ...
      <div>
        ...
        <p>Diese Daten sowie alle Daten dieser Website werden bei unserem Hosting-Provider webkeeper GmbH, 8604 Volketswil, Schweiz gespeichert, deren Datenschutzerklärung Sie <a href="https://www.webkeeper.ch/de/unternehmen/datenschutz" target="_blank" class="underline underline-offset-4 decoration-1 hover:no-underline">hier</a> finden.</p>
      </div>
      <div>
        <h2 class="!mb-0">
          Kontaktformular
        ...
        <p>Sie haben jederzeit die Möglichkeit, Ihre Einwilligung zur Verarbeitung der personenbezogenen Daten per E-Mail an <a href="mailto:info@apleona.com" class="underline underline-offset-4 decoration-1 hover:no-underline">info@apleona.com</a> zu widerrufen. In einem solchen Fall kann die Konversation nicht fortgeführt werden.</p>
      ...
      <div>
        ...
        <p>Sie können die Speicherung der Cookies durch eine entsprechende Einstellung Ihrer Browser-Software verhindern; wir weisen Sie jedoch darauf hin, dass Sie in diesem Fall gegebenenfalls nicht sämtliche Funktionen dieser Website vollumfänglich werden nutzen können. Sie können darüber hinaus die Erfassung der durch den Cookie erzeugten und auf Ihre Nutzung der Website bezogenen Daten (inkl. Ihrer IP-Adresse) an Google sowie die Verarbeitung dieser Daten durch Google verhindern, indem Sie das unter dem diesem <a href="https://tools.google.com/dlpage/gaoptout?hl=de" target="_blank" class="underline underline-offset-4 decoration-1 hover:no-underline">Link</a> verfügbare Browser-Plugin herunterladen und installieren.</p>
        <p>Mehr Informationen zum Umgang mit Nutzerdaten bei Google Analytics finden Sie in der Datenschutzerklärung von <a href="https://support.google.com/analytics/answer/6004245?hl=de" target="_blank" class="underline underline-offset-4 decoration-1 hover:no-underline">Google</a></p>
      ...
      <div>
        ...
        <p>Zudem erfolgt die Nutzung von Google Maps sowie der über Google Maps erlangten Informationen nach den Google-Nutzungsbedingungen <a href="http://policies.google.com/terms" target="_blank" class="underline underline-offset-4 decoration-1 hover:no-underline">policies.google.com/terms</a> und den Geschäftsbedingungen für <a href="http://www.google.com/intl/de_de/help/terms_maps.html" target="_blank" class="underline underline-offset-4 decoration-1 hover:no-underline">Google Maps</a>.</p>
      </div>
      <div>
        <h2 class="!mb-0">
          Recht auf Auskunft, Löschung, Sperrung
        </h2>
        <p>Sie haben jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung sowie ein Recht auf Berichtigung, Sperrung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit unter der im Impressum angegebenen Adresse an uns wenden oder eine E-Mail an <a href="mailto:info@apleona.com" class="underline underline-offset-4 decoration-1 hover:no-underline">info@apleona.com</a> senden.</p>
      </div>
      <div>
        <h2 class="!mb-0">
        ...
        <p>Weitere Informationen zur Datenverarbeitung durch Adobe Fonts finden Sie in der Datenschutzerklärung von Adobe Fonts <a href="https://www.adobe.com/de/privacy/policies/adobe-fonts.html" target="_blank" class="underline underline-offset-4 decoration-1 hover:no-underline">hier</a>.</p>
